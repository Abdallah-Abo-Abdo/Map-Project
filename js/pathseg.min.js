 ...
 * Original file: /npm/pathseg@1.2.0/pathseg.js
 *
          ...
          (n.prototype._parseNumber = function () {
            ...
            if (
              ...
              if (this._currentIndex != s)
                for (var a = this._currentIndex - 1, S = 1; s <= a; )
                  (e += S * (this._string.charAt(a--) - "0")), (S *= 10);
              if (
                this._currentIndex < this._endIndex &&
                "." == this._string.charAt(this._currentIndex)
              ) {
...
//# sourceMappingURL=/sm/4fcfee74f41b1a61423c90c996e033f25f1595d42c4b5d19b11d427f1ebf42ce.map
